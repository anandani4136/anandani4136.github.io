    ...
    return (
        <div id="experience" className={styles.main}>
            ...
            <div data-aos="fade-left" data-aos-duration="1300" data-aos-delay="500" data-aos-easing="ease-in-sine" className={styles.positionTag}>
                ...
                <ExperienceTag logo={icons[5]} title="Security and Software Engineer Intern" company="Discover Financial Services" time="06/24 - 08/24" tasks={["S", "L", "D"]} infoUrl='https://www.discover.com/company/our-company/'/>
                ...
                <ExperienceTag logo={icons[3]} title="Software Engineer" company="Reflections | Projections" time="02/23 - 09/24" tasks={["S", "L", "D"]} infoUrl='https://reflectionsprojections.org/'/>
                <ExperienceTag logo={icons[2]} title="Technology Chair" company="NOBE Illinois" time="01/23 - 05/24" tasks={["S", "L", "D"]} infoUrl='https://www.nobeillinois.org/'/>
                <ExperienceTag logo={icons[4]} title="Software Engineer Intern" company="Novaspect Inc." time="05/23 - 08/23" tasks={["S", "L", "D"]}infoUrl='https://www.novaspect.com/about-us/'/>
            </div>
